scrollbot = function (e, w) {
  ...
  this.init = function () {
    ...
    this.inP.style.cssText =
      "height:100%;overflow-y:auto;overflow-x:hidden;padding-right:" +
      (this.sbw + 20) +
    ...
    this.scrollBarHolder.onmousedown = function (e) {
      ...
      var relPos =
        ...
        _this.scrollBarHolder.clientHeight;
      _this.setScroll(
        (_this.inP.scrollHeight * relPos) / 100,
        _this.scrollSpeed
      );
    };
    ...
    this.orgPar.onmousemove = function (e) {
      if (_this.mdown) {
        ...
        _this.pC =
          ((_this.relY - _this.posCorrection) * 100) /
          _this.newPar.clientHeight;
    ...
    this.refresh = function () {
      ...
      _this.sB["height"] = _this.customHeight
        ? _this.sB["height"]
        : _this.sbHeight + "%";
    ...
    this.setStyle = function (sb, sbh) {
      if (sb != undefined) {
        ...
        if ("height" in sb) {
          ...
          sb["height"] =
            (parseFloat(sb["height"]) * 100) / _this.newPar.clientHeight + "%";
        }
        for (var x in sb) {
          _this.sB[x] = sb[x];
