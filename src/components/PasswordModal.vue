<template>
  ...
  >
    ...
    >
      ...
      >
        <path
          d="M511.8 399.4c62.5 0 113.2 50.6 113.2 113 0 62.5-50.7 113.1-113.2 113.1-62.6 0-113.2-50.6-113.2-113.1-0.1-62.4 50.6-113 113.2-113z m0 321.1c115 0 208.3-93.2 208.3-208 0-114.9-93.3-208-208.3-208-115.1 0-208.4 93.2-208.4 208s93.3 208 208.4 208z m500.3-247.2c7.6 11.1 11.9 24.7 11.9 39.1 0 11.7-2.8 22.7-8 32.5-3 4.7-6.2 9.3-9.5 13.8C902.9 705 735.8 803.2 545.3 813.6c-11.1 0.6-22.3 0.9-33.6 0.9s-22.5-0.3-33.6-0.9C286 803.1 117.6 703.1 14.2 554.7c-1.1-1.6-2.3-3.3-3.5-4.9C3.9 538.9 0 526.1 0 512.5c0-14.5 4.4-28 11.9-39.1l-0.3-0.3c107.5-156.9 287.2-260.5 491.3-263.4 3-0.1 6-0.2 8.9-0.2 3 0 6 0.1 8.9 0.2 204.2 2.8 383.9 106.6 491.4 263.6z"
          fill
    ...
    <template slot="footer">
      <a-button :loading="validating" @click="validatePassword" key="submit" type="primary">Submit</a-button>
    </template>
  </a-modal>
</template>
<script lang="ts">
